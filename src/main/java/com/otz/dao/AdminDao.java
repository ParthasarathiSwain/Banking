...
public class AdminDao {
	...
	public int updateAdmin(Admin admin) {
		...
		try {
			Connection con=DbConnection.getConnection();
			PreparedStatement ps=con.prepareStatement("update admin set adminName=?,adminEmail=?,adminPassword=?,adminPNum=?,adminPhoto=? where adminId=?");
			ps.setString(1,admin.getAdminName());
			ps.setString(2,admin.getAdminEmail());
			ps.setString(3,admin.getAdminPassword());
			ps.setString(4,admin.getAdminPNum());
			ps.setString(5, admin.getAdminPhoto());
