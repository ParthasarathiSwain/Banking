		      ...
		      <div class="modal-body">
		       <div class="card-body">
		           <div class="border p-3 rounded">
		               <form id="editadmin">
							<div class="mb-3">
									<label for="forminput" class="form-label">Admin Name</label>
								...
								<div class="mb-3">
									<label for="forminput2" class="form-label">Admin Email</label>
									<input type="email" id="adminEmail" name="adminEmail" class="form-control" required>
								</div>
								<div class="mb-3">
									<label for="forminput2" class="form-label">Admin Password</label>
									<input type="password" id="adminPass" name="adminPass" class="form-control" required>
								</div>
								<div class="mb-3">
									<label for="forminput3" class="form-label">Admin Phone</label>
									<input type="text" id="adminPNo" name="adminPNo" class="form-control" required>
								</div>
								<div class="mb-3">
									<label for="formFileMultiple" class="form-label">Photo</label>
									<input class="form-control" id="adminimg1" name="adminimg1" type="file" required id="formFileMultiple" multiple>
								</div>
								<div class="mb-3">
	    			...
	    			success:function(data,textStatus,jqXHR){ 					 
	    				...
	    				for (var key in data) {
	    					if (data.hasOwnProperty(key)) {
	    					  ...
	    					  s+="<img src='assets/adminImg/"+data[key].adminPhoto+"'class='product-box' width='44' height='44' alt=''>";
	    					  s+="<div class=''><p class='mb-0'>"+data[key].adminName+"</p></div></div> </td>";
	    					  ...
	    					  s+="<a  class='text-info admin_edit' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Edit' data-id='"+data[key].adminId+"' id='"+data[key].adminId+"'><i class='bi bi-pencil-fill'></i></a>";
	    					  s+="<a  class='text-danger admin_delete' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Delete' data-id='"+data[key].adminId+"' id='"+data[key].adminId+"'><i class='bi bi-trash-fill'></i></a>";
	    					  s+="</div></td></tr>";
	    					}
	    					i++;
	    				}
			 ...
			 $(document).on('click', '.admin_edit', function() {
				...
				$.ajax({
					...
					success:function(data,textStatus,jqXHR){
	    				...
	    				$("#adminPNo").val(data[0].adminPNum);
	    				$("#adminEmail").val(data[0].adminEmail);
	    				$("#adminPass").val(data[0].adminPassword);
  				},
				error:function(jqXHR,textStatus,errorThrown){
					$.toast({
		  		  	    text: "Something went wrong on server!", 
