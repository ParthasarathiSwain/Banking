						...
						<div class="card">
							...
							<form id="addbank">
								<div class="mb-3">
									...
									<input class="form-control " name="bankname"  type="text" required placeholder="Enter Bank Name" id="forminput" >
									<input  type="hidden" name="event" value="addBank" >
								</div>
								<div class="mb-3">
									<label for="forminput2" class="form-label">Bank Email</label>
									<input class="form-control " name="bankemail" type="text" required placeholder="Enter Bank Email" id="forminput2" >
								</div>
								<div class="mb-3">
									<label for="forminput3" class="form-label">Bank Phone</label>
									<input class="form-control " name="bankphone"  type="text" required placeholder="Enter Bank Phone" id="forminput3" >
								</div>
								<div class="mb-3">
