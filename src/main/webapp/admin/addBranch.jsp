						...
						<div class="card">
							...
							<form id="addbranch">
								<div class="input-group mb-3">
									...
									<select name="bankId" class="form-select" id="inputGroupSelect02">
								...
								<div class="mb-3">
									<label for="forminput2" class="form-label">Branch Name</label>
									<input class="form-control " name="branchname" type="text" required placeholder="Enter Branch Name" id="forminput2" >
									<input  type="hidden" name="event" value="addBranch" >
								</div>
								<div class="mb-3">
									<label for="forminput3" class="form-label">Location</label>
									<input class="form-control " name="location"  type="text" required placeholder="Enter Branch Location" id="forminput3" >
								</div>
								<div class="mb-3">
									<label for="forminput4" class="form-label">Created By</label>
									<input class="form-control" name="createdby" type="text" required id="forminput4" >
								</div>
								<div class="mb-3">
