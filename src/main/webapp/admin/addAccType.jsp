       ...
       <main class="page-content">
   		<!--breadcrumb-->
			<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
				<div class="breadcrumb-title pe-3">ACCOUNT TYPE</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">ADD ACCOUNT TYPE</li>
							</ol>
						</nav>
					</div>
			</div>
		...
		<div class="row">
					<div class="col-xl-9 mx-auto">
						<h6 class="mb-0 text-uppercase">ADD ACCOUNT TYPE</h6>
						<hr/>
						<div class="card">
							<div class="card-body">
							<form id="addacctype">
...
<script src="assets/js/bootstrap.bundle.min.js"></script>
 ...
 <script>
		  	$(document).ready(function(){
		  		...
		  		$("#addacctype").on('submit',function(event){
